...
import 'package:moviesflix/tv_show_detail.dart';
...
class SearchedContent extends StatefulWidget {
  final String search;
  SearchedContent(this.search);
  @override
  _SearchedContentState createState() => _SearchedContentState();
}

class _SearchedContentState extends State<SearchedContent> {
  ...
  Future<Map> getJson(dynamic search) async {
    var url = 'http://api.themoviedb.org/3/search/movie?api_key=6a7755e386468be6db6963df9ba108fd&query=$search';
